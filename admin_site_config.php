				...
				<div id="spam">
					<div class="config_options">
						...
						<div class="input_group" id="recaptcha_select">
							...
							<div class="helpcontent">
								<?php echo KT_I18N::translate('This can help limit the nember of spam attempts to register on your site.<br>It requires a pair of Google rCaptcha v2 API keys. Help to obtian this can be found on this kiwitrees FAQ page: <a href="https://kiwitrees.net/faqs/administration/site_admin/" target="_blank">Google reCaptcha v2</a>'); ?>
							</div>
						</div>
					</div>
