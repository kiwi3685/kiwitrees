...
class backup_to_dropbox_WT_Module extends WT_Module implements WT_Module_Config {
	...
	private function config() {
		...
		<div id="backup_to_dropbox-page">
			<a class="current faq_link" href="http://kiwitrees.net/faqs/modules/backup-dropbox/" target="_blank" rel="noopener noreferrer" title="<?php echo WT_I18N::translate('View FAQ for this page.'); ?>"><?php echo WT_I18N::translate('View FAQ for this page.'); ?><i class="fa fa-comments-o"></i></a>
			...
			<div class="backup_settings" style="margin: 20px auto;">
				...
				<form method="post">
					...
					<div class="config_options odd">
						<label><?php echo /* I18N: Dropbox App folder name */ WT_I18N::translate('Dropbox App folder'); ?></label>
						<div class="input_group">
							<input type="text" name="NEW_DB_FOLDER" value="<?php echo $DB_FOLDER; ?>" required autocomplete="off">
						</div>
					</div>
					<div class="config_options even">
						<label><?php echo /* I18N: Dropbox App secure access token */ WT_I18N::translate('Dropbox App token'); ?></label>
						<div class="input_group">
							<input type="text" name="NEW_DB_TOKEN" value="<?php echo $DB_TOKEN; ?>" pattern=".{56,}"   required title="<?php echo WT_I18N::translate('Not a valid Dropbox token'); ?>" autocomplete="off">
						</div>
					</div>
					<?php if ($DB_FOLDER) { ?>
						<div class="config_options odd">
		...
		<?php if(WT_Filter::post('action') == 'backup') { ?>
			<style>
			...
			<div>
				...
				<table id="dropbox">
					<tr>
						<th><?php echo WT_I18N::translate('File name'); ?></th>
						<th><?php echo WT_I18N::translate('Size'); ?></th>
						<th><?php echo WT_I18N::translate('Last modified date'); ?></th>
					</tr>
					<?php
    ...
    */
    public function uploadFile($file, $db_token){
        ...
        $headers	= array('Authorization: Bearer '. $db_token,
