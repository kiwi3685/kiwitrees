...
class gallery_KT_Module extends KT_Module implements KT_Module_Menu, KT_Module_Block, KT_Module_Config {
	...
	private function config() {
		...
		?>
		<div id="<?php echo $this->getName();?>">
			<a class="current faq_link" href="<?php echo KT_KIWITREES_URL; ?>/kb/user-guide/gallery/" target="_blank" rel="noopener noreferrer" title="<?php echo KT_I18N::translate('View FAQ for this page.'); ?>"><?php echo KT_I18N::translate('View FAQ for this page.'); ?><i class="fa fa-comments-o"></i></a>
