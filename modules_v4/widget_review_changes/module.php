	...
	public function configureBlock($widget_id) {
		...
		<tr>
			<td class="descriptionbox wrap width33">
				<?php echo KT_I18N::translate('Send out reminder emails?'); ?>
			</td>
			<td class="optionbox">
				<?php echo edit_field_yes_no('sendmail', $sendmail); ?>
				<br>
				<?php echo KT_I18N::translate('Reminder email frequency (days)')."&nbsp;<input type='text' name='days' value='".$days."' size='2'>"; ?>
			</td>
		</tr>
	<?php }
}
