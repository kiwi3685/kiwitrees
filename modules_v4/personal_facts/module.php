...
class personal_facts_KT_Module extends KT_Module implements KT_Module_Tab {
	// Extend KT_Module
	...
	public function getDescription() {
		return /* I18N: Description of the “Facts and events” module */ KT_I18N::translate('A tab showing the facts and events of an individual.');
	}
	...
	public function getTabContent() {
		...
		if (count($indifacts) == 0) {
			echo '<tr><td colspan="2" class="facts_value">', KT_I18N::translate('There are no Facts for this individual.'), '</td></tr>';
		} ?>
			<tr id="row_top">
				<td colspan="2" class="descriptionbox rela">
					...
					<?php endif; ?>
					<?php if (file_exists(KT_Site::preference('INDEX_DIRECTORY') . 'histo.' . KT_LOCALE . '.php')) : ?>
						<input id="checkbox_histo" type="checkbox">
						<label for="checkbox_histo"><?php echo KT_I18N::translate('Historical facts'); ?></label>
					<?php endif; ?>
				</td>
			</tr>
		<?php
