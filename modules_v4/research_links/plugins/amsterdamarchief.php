...
class amsterdamarchief_plugin extends research_base_plugin {
	...
	static function create_sublink($fullname, $givn, $first, $middle, $prefix, $surn, $surname, $birth_year, $death_year, $gender) {
		...
		$collection = array(
				...
				"BR Geannexeerde gemeenten"			=> "bevolkingsregisters_geannexeerd/zoek/query.nl.pl?i1=1&v1=" . $givn . "&a1=" . $surname . "&x=40&z=b",
				...
				"Militieregisters 1828-1940"		=> "militieregisters_1828-1940/zoek/query.nl.pl?i1=1&v1=" . $givn . "&a1=" . $surname . "&x=41&z=b",
