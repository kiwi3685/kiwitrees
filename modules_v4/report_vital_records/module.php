...
class report_vital_records_WT_Module extends WT_Module implements WT_Module_Report {
	...
	public function show() {
		...
		<div id="page" class="vital_records">
			...
			<?php if ($action == 'go') {
				...
				$list = report_vital_records($name, $place, $b_fromJD, $b_toJD, $d_fromJD, $d_toJD, WT_GED_ID);
