...
class clippings_KT_Module extends KT_Module implements KT_Module_Menu, KT_Module_Sidebar {
								...
								<tr>
									<td class="topbottombar">
										<button class="btn btn-primary submit" type="submit">
											<i class="fa fa-plus"></i><?php echo KT_I18N::translate('Continue adding'); ?>
										</button>
									</td>
								</tr>
							</table>
						...
						<form method="get" name="addin" action="module.php">
							...
							<table>
								...
								<tr>
									...
									<td class="optionbox">
										<button class="btn btn-primary submit" type="submit">
											<i class="fa fa-plus"></i><?php echo KT_I18N::translate('Add'); ?>
										</button>
									</td>
								</tr>
							</table>
							...
							<table>
								...
								<tr>
									<td class="topbottombar" colspan="2">
										<button class="btn btn-primary submit" type="submit">
											<i class="fa fa-cart-arrow-down"></i><?php echo KT_I18N::translate('Download now'); ?>
										</button>
									</td>
								</tr>
							</table>
			...
			$out .= '<form action="module.php" method="get" onsubmit="continueAjax(this); return false;">
				...
				<table>
					...
					<tr>
						<td class="topbottombar">
							<button class="btn btn-primary submit" type="submit">
								<i class="fa fa-plus"></i>' . KT_I18N::translate('Continue adding') . '
							</button>
					</td>
					</tr>
				</table>
	...
	public function downloadForm($clip_ctrl) {
		...
		<button class="btn btn-primary submit" type="submit">
			<i class="fa fa-cart-arrow-down"></i>' . KT_I18N::translate('Download now') . '
		</button>
