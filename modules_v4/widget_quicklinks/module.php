...
//		}
	...
	// Implement class WT_Module_Widget - FOR FUTURE DEVELOPMENT
...
/*
		...
		echo '
			<tr><td class="descriptionbox">' . WT_I18N::translate('Select links to show in this block') . '</td></tr>
			<tr>
				<td>
					<p>
						<label>Icon:</label>
					...
					<p>
						<label for="url">' .  WT_I18N::translate('URL') . '</label>
						<input class="widefat" id="url" name="url" type="text" value="" />
					</p>

					<p>
						<label for="button_text">' .  WT_I18N::translate('Button Text') . '</label>
