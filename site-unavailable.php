...
echo '</ol>';
echo '<p class="good">', KT_I18N::translate('If you cannot resolve the problem yourself, you can ask for help on the forums at <a href="http://kiwitrees.net/forums/">Kiwitrees.net</a>'), '</p>';
echo '</div>';
echo '</body>';
echo '</html>';
