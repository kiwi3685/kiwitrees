	...
	<div id="footer">
		<?php if (!array_key_exists('contact', KT_Module::getActiveModules())){ ?>
			<div class="contact_links">
				<a href="message.php?url=<?php echo addslashes(urlencode(get_query_url())); ?>" target="_blank" rel="noopener noreferrer" title="<?php echo KT_I18N::translate('Send Message'); ?>">
