...
echo '<div id="out-', $boxID ,'" ', $outBoxAdd, '>
		<div class="compact_view" style="width:60px;margin:0 auto;height:60px;text-align:center;">', $thumbnail, '</div>
		<div style="height:33px; margin:10px 0 0 0;text-align:center;text-overflow:ellipsis;">
