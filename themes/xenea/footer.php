	...
	<div id="footer">
		<?php if (!array_key_exists('contact', KT_Module::getActiveModules())){ ?>
			<div class="contact_links">
				<a href="#" onclick="window.open('message.php?url=<?php echo KT_SERVER_NAME . KT_SCRIPT_PATH . addslashes(rawurlencode(get_query_url())); ?>', '_blank')" rel="noopener noreferrer" title="<?php echo KT_I18N::translate('Send Message'); ?>">
