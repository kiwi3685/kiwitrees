...
class simpl_duplicates_WT_Module extends WT_Module implements WT_Module_Config {
	...
	public function getConfigLink() {
		return 'module.php?mod='.$this->getName().'&amp;mod_action=admin_duplicates';
	}
	...
	private function config() {
		...
		if (!empty($WT_SESSION['duplicates_gedcom_id'])) {
			$gedcom_id = $WT_SESSION['duplicates_gedcom_id'];
		} else {
			$WT_SESSION['duplicates_gedcom_id'] = $gedcom_id;
		}
		...
		echo '
			<div id="sim_dup">
				...
				<form method="get" name="duplicates_form" action="module.php">
