...
class zoetermeerarchief_plugin extends research_base_plugin { // THIS NAME MUST MATCH EXACTLY TO THE FILE NAME AND SHOULD BE SIMILAR TO THE DISPLAY NAME FOR BEST SORTING
	static function getName() {
		return 'Zoetermeer Oud Soetermeer'; // THIS IS THE DISPLAY NAME
	}
	...
	static function create_link($fullname, $givn, $first, $middle, $prefix, $surn, $surname, $birth_year) { // SEE FAQ FOR EXPLANATION OF EACH PART
		return $link = 'http://www.allezoetermeerders.nl/stamboom/2/zoeken.html?year_field=document&last_name=' . $surname . '&middle_name=&first_name=' . $first . '';
	}
