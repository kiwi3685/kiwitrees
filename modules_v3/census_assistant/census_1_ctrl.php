...
<div id="census_assist-page">
    <h2><?php echo $controller->getPageTitle(); ?>
        <a class="faq_link" href="http://kiwitrees.net/faqs/modules/census-assistant/" alt="' . WT_I18N::translate('View FAQ for this page.') . '" target="_blank" rel="noopener noreferrer">
