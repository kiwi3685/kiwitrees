...
$plugin_name = "Regnal Years"; /* I18N: Name of a plugin. */ WT_I18N::translate('Regnal Years');
	...
	<div id="regnal">' .
		...
		<form name="RegnalYear">
			<label class="main">' . WT_I18N::translate('Enter the month and day') . '</label>
				...
				$html .= '</select>
				<label class="secondary">' . WT_I18N::translate('Day') . '</label>
...
<!-- SCRIPTS -->
 <script><!--
	function Calculate() {
		...
		if (isNaN(regnalyear)){
			alert("<?php echo WT_I18N::translate('You must enter a regnal year'); ?>")
			regnalyear = "error"
		}
		...
		if (Monarch == "William I"){
			if (regnalyear > 21){
				alert("<?php echo WT_I18N::translate('William I only reigned for 21 years'); ?>")
				regnalyear = "error"
			}
	...
	//alert(regnalyear)
		if (Monarch == "WilliamII"){
			if (regnalyear > 13){
				alert("<?php echo WT_I18N::translate('William II only reigned for 13 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryI"){
			if (regnalyear > 36){
				alert("<?php echo WT_I18N::translate('Henry I only reigned for 36 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "Stephen"){
			if (regnalyear > 19){
				alert("<?php echo WT_I18N::translate('Stephen only reigned for 19 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryII"){
			if (regnalyear > 35){
				alert("<?php echo WT_I18N::translate('Henry II only reigned for 35 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "RichardI"){
			if (regnalyear > 10){
				alert("<?php echo WT_I18N::translate('Richard I only reigned for 10 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryIII"){
			if (regnalyear > 57){
				alert("<?php echo WT_I18N::translate('Henry III only reigned for 57 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardI"){
			if (regnalyear > 35){
				alert("<?php echo WT_I18N::translate('Edward I only reigned for 35 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardII"){
			if (regnalyear > 20){
				alert("<?php echo WT_I18N::translate('Edward II only reigned for 20 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardIII"){
			if (regnalyear > 51){
				alert("<?php echo WT_I18N::translate('Edward III only reigned for 51 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "RichardII"){
			if (regnalyear > 23){
				alert("<?php echo WT_I18N::translate('Richard II only reigned for 23 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryIV"){
			if (regnalyear > 14){
				alert("<?php echo WT_I18N::translate('Henry IV only reigned for 14 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryV"){
			if (regnalyear > 10){
				alert("<?php echo WT_I18N::translate('Henry V only reigned for 10 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardIV"){
			if (regnalyear > 23){
				alert("<?php echo WT_I18N::translate('Edward IV only reigned for 23 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardV"){
			if (regnalyear > 1){
				alert("<?php echo WT_I18N::translate('Edward V only reigned for 1 year'); ?>")
				regnalyear = "error"
			}
			regnalyear = regnalyear + 1482
			if (Month == 4){
				if (Day < 9){
					alert("<?php echo WT_I18N::translate('Edward V\'s reign lasted from 9 April to 25 June'); ?>")
					regnalyear = "error"
				}
			}
			if (Month < 4) {
		...
		if (Monarch == "RichardIII"){
			if (regnalyear > 3){
				alert("<?php echo WT_I18N::translate('Richard III only reigned for 3 years'); ?>")
				regnalyear = "error"
			}
			regnalyear = regnalyear + 1482
			if (Month == 6){
		...
		if (Monarch == "HenryVII"){
			if (regnalyear > 24){
				alert("<?php echo WT_I18N::translate('Henry VII only reigned for 24 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "HenryVIII"){
			if (regnalyear > 38){
				alert("<?php echo WT_I18N::translate('Henry VIII only reigned for 38 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "EdwardVI"){
			if (regnalyear > 7){
				alert("<?php echo WT_I18N::translate('Edward VI only reigned for 7 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "ElizabethI"){
			if (regnalyear > 45){
				alert("<?php echo WT_I18N::translate('Elizabeth I only reigned for 45 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "JamesI"){
			if (regnalyear > 23){
				alert("<?php echo WT_I18N::translate('James I had only 23 regnal years as King of England'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "CharlesI"){
			if (regnalyear > 24){
				alert("<?php echo WT_I18N::translate('Charles I only reigned for 24 years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "CharlesII"){
			if (regnalyear > 37){
				alert("<?php echo WT_I18N::translate('Charles II only had 37 regnal years'); ?>")
				regnalyear = "error"
			}
		...
		if (Monarch == "JamesII"){
			if (regnalyear > 4){
				alert("<?php echo WT_I18N::translate('James II only reigned for 4 years'); ?>")
			regnalyear = "error"
				}
		...
		if (Monarch == "Mary"){
			if (regnalyear > 6){
				alert("<?php echo WT_I18N::translate('Mary only reigned for 4 years'); ?>")
				regnalyear = "error"
			}
			alert("<?php echo WT_I18N::translate('This site calculates the regnal years for Mary, ignoring Philip and his regnal years. The calculation of regnal years between July 9, 1553 and November 17, 1558 is complicated by Mary\'s marriage to Philip.'); ?>")
	...
	if (Monarch == "William and Mary"){
			if (regnalyear > 14){
				alert("<?php echo WT_I18N::translate('William only reigned for 14 years (the first six with Mary)'); ?>")
				return
			}
		...
		if (Monarch == "Anne"){
			if (regnalyear > 13){
				alert("<?php echo WT_I18N::translate('Anne only reigned for 13 years.'); ?>")
				return
			}
	...
	if (Monarch == "GeorgeI"){
			if (regnalyear > 13){
				alert("<?php echo WT_I18N::translate('George I only reigned for 13 years.'); ?>")
				return
			}
	...
	if (Monarch == "GeorgeII")
		{
			if (regnalyear > 34){
				alert("<?php echo WT_I18N::translate('George II only reigned for 34 years.'); ?>")
				return
			}
			if (regnalyear > 26){
		...
		if (Monarch == "GeorgeIII"){
			if (regnalyear > 60){
				alert("<?php echo WT_I18N::translate('George III only reigned for 60 years.'); ?>")
				return
			}
		...
		if (Monarch == "EdwardVII"){
			if (regnalyear > 10){
				alert("<?php echo WT_I18N::translate('Edward VII only reigned for 10 years.'); ?>")
				return
			}
		...
		if (Monarch == "GeorgeV"){
			if (regnalyear > 26){
				alert("<?php echo WT_I18N::translate('George V only reigned for 26 years.'); ?>")
				return
			}
		...
		if (Monarch == "GeorgeVI"){
			if (regnalyear > 16){
				alert("<?php echo WT_I18N::translate('George VI only reigned for 16 years.'); ?>")
				return
			}
		...
		if (Monarch == "EdwardVIII"){
			alert("<?php echo WT_I18N::translate('Edward VIII only reigned from Jan 20 to December 11, 1936.'); ?>")
			regnalyear = 1936
		}

		if (Monarch == "John") {
			alert("<?php echo WT_I18N::translate('John was crowned on Ascension day in 1199. His regnal years run from one Ascension day to the next and are thus highly irregular. Use the Ecclesiastical calendar page to calculate Ascension day'); ?>")
			regnalyear = "error"
		}

		if (Monarch == "Jane") {
			alert("<?php echo WT_I18N::translate('Jane only ruled from July 6th to July 19th, 1553'); ?>")
			regnalyear = "error"
		}
