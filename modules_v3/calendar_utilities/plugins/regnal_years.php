...
$plugin_name = "Regnal Years"; // need double quotes, as file is scanned/parsed by script
...
$html.='
	<style type="text/css">
		#regnal #regnal h1 {font-size:15px; font-weight:bold;}
		#regnal p {padding:0;}
		#regnal label.main {text-align:left; width:auto; font-size: 14px; font-weight:bold; display:block;}
		#regnal label.secondary {text-align:left; width:auto; font-size: 13px; margin:10px; line-height:40px;}
	...
	<div id="regnal">
		...
		<form name="RegnalYear">
			<label class="main">Enter the month and day:
				<label class="secondary">Month: <span style="font-weight:normal;">(January=1)</span></label> 
				...
				<label class="secondary">Day:</label>
			...
			<p class="note">* Double years such as &quot;1324/5&quot; reflect Old Style dating (see note below).</p>
			<label class="main">Notes
				<p class="note">1. Keep in mind that a monarch\'s last regnal year is cut short by death or deposition and may not include all dates.</p>
				<p class="note">2. Also, remember that while the so-called &quot;Christian year&quot; began on January 1, the legal year began on March 25. For example, January 1 in Elizabeth I\'s 1st regnal year occurred in the Christian year1559, but legally the year was still 1558, and would be until March 25. From January 1 to March 24, the convention is to note both years with a slash between them, e.g. &quot;1558/9.&quot;</p>
				<p class="note">3. Remember also that from 1582 onward, English dates (Old Style) will not correspond with Continental dates.</p>
			</label>
		</form>
	</div>
';
...
<!-- SCRIPTS -->
 <script><!--
	function Calculate() {
		...
		if (isNaN(regnalyear)){alert("You must enter a regnal year")
			regnalyear = "error"
		}
