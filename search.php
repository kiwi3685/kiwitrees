	...
	<div id="search-page-table">';
		...
		if ($controller->action == "soundex") {
			echo '<div class="label">' , WT_I18N::translate('Given name'), '</div>
				<div class="value"><input tabindex="3" type="text" data-autocomplete-type="GIVN" name="firstname" value="' , htmlspecialchars($controller->firstname), '" autofocus></div>
				<div class="label">' , WT_I18N::translate('Last name'), '</div>
				<div class="value"><input tabindex="4" type="text" data-autocomplete-type="SURN" name="lastname" value="' , htmlspecialchars($controller->lastname), '"></div>
