            ...
            <div id="accordion">
                ...
                <div id="config-media">
                    ...
                    <div class="config_options">
                        ...
                        <div class="input_group">
                            <input type="url" name="NEW_IMAGE_EDITOR" value="<?php echo $IMAGE_EDITOR; ?>" size="50" maxlength="255" dir="ltr">
                            <div class="helpcontent">
                ...
                <div id="layout-options">
                    ...
                    <div class="config_options">
                        ...
                        <div class="input_group">
                            <input type="number" name="NEW_COMMON_TYPES_THRESHOLD" value="<?php echo get_gedcom_setting(KT_GED_ID, 'COMMON_TYPES_THRESHOLD'); ?>" maxlength="5">
                            <div class="helpcontent">
