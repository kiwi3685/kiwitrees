 ...
 */
class WT_Census_AbstractCensusColumn {
	/** @var CensusInterface */
	private $census;
	 ...
	 *
	 * @param WT_Census_CensusInterface $census - The census to which this column forms part.
	 ...
	 */
	public function __construct(WT_Census_CensusInterface $census, $abbr, $title, $style='') {
		$this->census = $census;
		$this->abbr   = $abbr;
		$this->title  = $title;
		$this->style  = $style;
	...
	public function date() {
		return new WT_Date($this->census->censusDate());
	}
	 ...
	 */
	public function father(WT_Person $individual) {
	 ...
	 * @return Individual|null
	 */
	public function mother(WT_Person $individual) {
		$family = $individual->getPrimaryChildFamily();
	 ...
	 * @return Family|null
	 */
	public function spouseFamily(WT_Person $individual) {
