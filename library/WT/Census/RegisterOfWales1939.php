 ...
 */
class WT_Census_RegisterOfWales1939 extends WT_Census_CensusOfWales implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new WT_Census_CensusColumnSurnameGivenNames($this, 'Name', 'Surname & other names'),
			...
			new WT_Census_CensusColumnBirthDayMonthSlashYear($this, 'DOB', 'Date of birth'),
			new WT_Census_CensusColumnConditionEnglish($this, 'MC', 'Marital Condition - Married, Single, Unmarried, Widowed or Divorced'),
			new WT_Census_CensusColumnOccupation($this, 'Occupation', 'Occupation'),
			new WT_Census_CensusColumnOccupation($this, 'Other', 'Instructions'),
		);
	}
}
