 ...
 */
class WT_Census_CensusOfEngland1841 extends WT_Census_CensusOfEngland implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			new WT_Census_CensusColumnFullName($this, 'Name', 'Name', 'width: 250px;'),
