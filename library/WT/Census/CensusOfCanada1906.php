 ...
 */
class WT_Census_CensusOfCanada1906 extends WT_Census_CensusOfCanada implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new WT_Census_CensusColumnBirthPlaceSimple($this, 'BP', 'Country or place of birth'),
			new WT_Census_CensusColumnNull($this, 'Immigration', 'Year of immigration to Canada'),
			new WT_Census_CensusColumnNull($this, 'PO Address', 'Post Office Address (entered for the head of family only)'),
		);
	}
}
