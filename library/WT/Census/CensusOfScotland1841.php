 ...
 */
class WT_Census_CensusOfScotland1841 extends WT_Census_CensusOfScotland implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new WT_Census_CensusColumnBornForeignParts($this, 'EIF', 'Born in England, Ireland or foreign parts'),
		);
	}
}
