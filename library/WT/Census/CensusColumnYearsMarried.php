 ...
 */
class WT_Census_CensusColumnYearsMarried extends WT_Census_AbstractCensusColumn implements WT_Census_CensusColumnInterface {
	/**
	...
	public function generate(WT_Person $individual, WT_Person $head = null) {
		...
		if ($marriage_date === null) {
			...
			return (string) WT_Date::getAge($marriage_date, $this->date(), 0);
		}
	}
}
