 ...
 */
class WT_Census_CensusOfFrance1851 extends WT_Census_CensusOfFrance implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new WT_Census_CensusColumnOccupation($this, 'Professions', ''),
