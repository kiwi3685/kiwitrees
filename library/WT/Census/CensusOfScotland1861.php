 ...
 */
class WT_Census_CensusOfScotland1861 extends WT_Census_CensusOfScotland implements WT_Census_CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new WT_Census_CensusColumnNull($this, 'Infirm', 'Whether blind or deaf-and-dumb'),
			new WT_Census_CensusColumnNull($this, 'School', 'Number of children between 5 and 13 attending school'),
		);
	}
}
