...
class WT_Controller_Ancestry extends WT_Controller_Chart {
	...
	function print_child_ascendancy($person, $sosa, $depth) {
		...
		if ($family && $new && $depth>0) {
			...
			echo '<img src="', $WT_IMAGES['spacer'], '" height="2" width="', $Dindent, '" align="middle" alt=""><a href="#" onclick="return expand_layer(\'sosa_', $sosa, '\');" class="top"><i id="sosa_', $sosa, '_img" class="icon-minus" title="', WT_USER_CAN_EDIT ? WT_I18N::translate('Edit family') : WT_I18N::translate('View family'), '"></i></a>';
