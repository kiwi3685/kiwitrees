...
class WT_Controller_Descendancy extends WT_Controller_Chart {
	...
	function print_family_descendancy($person, $family, $depth) {
		...
		echo "<a href=\"#\" onclick=\"expand_layer('".$family->getXref().$personcount."'); return false;\" class=\"top\"><i id=\"".$family->getXref().$personcount."_img\" class=\"icon-minus\" title=\"".WT_USER_CAN_EDIT ? WT_I18N::translate('Edit family') : WT_I18N::translate('View family')."\"></i></a>";
