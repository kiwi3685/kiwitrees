...
function utf8_script($string) {
	...
	while ($pos<$strlen) {
		...
		if (strpos(WT_UTF8_LATIN_CHARACTERS, $chr)!==false) {
			...
			return 'Arab';
		} elseif (strpos(WT_UTF8_GEORGIAN_CHARACTERS, $chr)!==false) {
			return 'Geor';
		}
		$pos+=$chrlen;
	}
...
define('WT_UTF8_GEORGIAN_CHARACTERS', 'ႠႡႢႣႤႥႦႧႨႩႪႫႬႭႮႯႰႱႲႳႴႵႶႷႸႹႺႻႼႽႾႿჀჁჂჃჄჅჇჍაბგდევზთიკლმნოპჟრსტუფქღყშჩცძწჭხჯჰჱჲჳჴჵჶჷჸჹჺ჻ჼჽჾჿႠႡႢႣႤႥႦႧႨႩႪႫႬႭႮႯႰႱႲႳႴႵႶႷႸႹႺႻႼႽႾႿჀჁჂჃჄჅაბგდევზთიკლმნოპჟრსტუფąღყშჩცძწჭხჯჰჱჲჳჴჵჶ');
